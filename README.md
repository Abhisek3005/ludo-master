...
This fork includes offline play, single player against simple bots, online friend rooms, Teams 2v2 mode, and browser voice chat. See `ONLINE_SETUP.md` for Firebase/Vercel setup.
