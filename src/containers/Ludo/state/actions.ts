...
export enum ActionTypes {
  ...
  HYDRATE_ONLINE_STATE = 'ludo/HYDRATE_ONLINE_STATE',
}
...
export const hydrateOnlineState = (gameData: IState): IReduxAction<ActionTypes.HYDRATE_ONLINE_STATE, { gameData: IState }> => ({
  data: { gameData },
  type: ActionTypes.HYDRATE_ONLINE_STATE,
});
...
export type Actions =
  ...
  | ReturnType<typeof hydrateOnlineState>
